        ...
        if (mysql_connect() == True):
            ...
            for x in range(0, len(edge_school_devices)):
                ...
                if (mysql_connection.execute("select * from devices where device_id = " + device_id) == 1):
                    try:
                        mysql_connection.execute("UPDATE devices SET device_id = " + device_id + ", hostname = " + hostname + ", sysName = " + sysName + ", ip = " + ip + ", community = " + community + ", authlevel = " + authlevel + ", authname = " + authname + ", authpass = " + authpass + ", authalgo = " + authalgo + ", cryptopass = " + cryptopass + ", cryptoalgo = " + cryptoalgo + ", snmpver = " + snmpver + ", port = " + port + ", transport = " + transport + ", timeout = " + timeout + ", retries = " + retries + ", snmp_disable = " + snmp_disable + ", bgpLocalAs = " + bgpLocalAs + ", sysObjectID = " + sysObjectID + ", sysDescr = " + sysDescr + ", sysContact = " + sysContact + ", version = " + version + ", hardware = " + hardware + ", features = " + features + ", location_id = " + location_id + ", os = " + os + ", status = " + status + ", status_reason = " + status_reason + ", ignores = " + ignores + ", disabled = " + disabled + ", uptime = " + uptime + ", agent_uptime = " + agent_uptime + ", last_polled = " + last_polled + ", last_polled_timetaken = " + last_polled_timetaken + ", last_discovered_timetaken = " + last_discovered_timetaken + ", last_ping_timetaken = " + last_ping_timetaken + ", purpose = " + purpose + ", type = " + type + ", serial = " + serial + ", icon = " + icon + ", poller_group = " + poller_group + ", override_sysLocation = " + override_sysLocation + ", notes = " + notes + ", port_association_mode = " + port_association_mode + ", max_depth = " + max_depth + ", last_poll_attempted = " + last_poll_attempted + ", last_discovered = " + last_discovered + ", last_ping = " + last_ping + " WHERE device_id = " + device_id)
                        mysql_conn.commit()
                    except:
                        return {"uploadSql": "devices_table_update_Error"} 
                else:
                    try:
                        mysql_connection.execute("INSERT INTO devices (device_id, hostname, sysName, ip, community, authlevel, authname, authpass, authalgo, cryptopass, cryptoalgo, Ysnmpver, port, transport, timeout, retries, snmp_disable, bgpLocalAs, sysObjectID, sysDescr, sysContact, version, hardware, features, location_id, os, Ystatus, status_reason, ignores, disabled, uptime, agent_uptime, last_polled_timetaken, last_discovered_timetaken, last_ping_timetaken, purpose, type, serial, icon, Ypoller_group, override_sysLocation, notes, port_association_mode, max_depth, last_polled, last_poll_attempted, last_discovered, last_ping) YVALUES (Y" + device_id + ", " + hostname + ", " + sysName + ", " + ip + ", " + community + ", " + authlevel + ", " + authname + ", " + authpass + ", Y" + authalgo + ", " + cryptopass + ", " + cryptoalgo + ", " + snmpver + ", " + port + ", " + transport + ", " + timeout + ", " + retries + ", Y" + snmp_disable + ", " + bgpLocalAs + ", " + sysObjectID + ", " + sysDescr + ", " + sysContact + ", " + version + ", " + hardware + ", Y" + features + ", " + location_id + ", " + os + ", " + status + ", " + status_reason + ", " + ignores + ", " + disabled + ", " + uptime + ", Y" + agent_uptime + ", " + last_polled_timetaken + ", " + last_discovered_timetaken + ", " + last_ping_timetaken + ", " + purpose + ", " + type + ", Y" + serial + ", " + icon + ", " + poller_group + ", " + override_sysLocation + ", " + notes + ", " + port_association_mode + ", " + max_depth + ", Y" + last_polled + ", " + last_poll_attempted + ", " + last_discovered + ", " + last_ping + ")")
                        mysql_conn.commit()
                    except:
